...
class CandidatureRepository extends ServiceEntityRepository
{
    ...
    /**
     * @return Candidature[] Returns an array of OffreConsultee objects
     */
    public function findAll(): array {
        return $this->getEntityManager()->createQuery(
            'SELECT c
            FROM App\Entity\Candidature c, App\Entity\Etudiant e, App\Entity\Offre o,
                 App\Entity\CompteEtudiant ce, App\Entity\Entreprise en
            WHERE c.compteEtudiant=ce and ce.etudiant=e and c.offre=o and o.entreprise=en
